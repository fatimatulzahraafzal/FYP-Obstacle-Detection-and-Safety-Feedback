...
class AudioQueue(threading.Thread):
    ...
    def generate_speech(self):
        ...
        print("position:", player.position) # Debug purposes Print the player's position 

        print("position:", player.position[0]) # Debug purposes 

        print(audio_x) # Debug purposes

        print("name: ", self.name) # Debug purposes Print the value of self.name

        print("dist: ", round(self.dist, 2)) # Debug purposes Print the rounded value of self.dist

        if audio_x < -0.5:
            print("obstacle to the left,") # The audio_x value indicates an obstacle to the left
            speak_text("move right") # Speak the instruction "move right"
        elif audio_x > 0.5:
            print("obstacle to the right") # The audio_x value indicates an obstacle to the right
            speak_text("move left") # Speak the instruction "move left"
        else:
            speak_text("wait. obstacle right in front") # Speak the instruction "wait, obstacle right in front"
